...
instructor: ["Samuel Meehan","Dan Guest","Matthew Feickert","Giordon Stark","Danika MacDonnel","Nils Krumnack","Henry Schreiner","Karol Krizka","Adam Parker"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Shih Chieh Hsu","Zachary Marshall"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://indico.cern.ch/event/816946/            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
